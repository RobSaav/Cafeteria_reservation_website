...
<body>
    ...
    <header class="header">
        ...
        <div class="header__texto">
            <h2 class="no-margin">¿Algun problema?</h2>
            <p class="no-margin">Diganos todo lo que necesite para contactarlo cuando podamos</p>
        </div>
    </header>
    ...
    <main class="contenedor">
        ...
        <form action="datos2.php" method="POST" class="formulario">
            <div class="campo">
            ...
            <div class="campo">
                ...
                <textarea class="campo__field campo__field--textarea" name="Mensaje"
                    placeholder="¿Que quieres decirnos?"></textarea>
            </div>
