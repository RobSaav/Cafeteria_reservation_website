...
<body>
    ...
    <main class="contenedor">
        <h3 class="centrar-texto">Sus datos Mesa pequeña
        ...
        <form action="datos.php" method="POST" class="formulario">
            ...
            <div class="campo">
                ...
                <textarea class="campo__field campo__field--textarea" name="Mensaje"
                    placeholder="Especifique te tipo de mesa quiere"></textarea>
            </div>

            <div class="campo">
                <label class="campo__label" for="email">Personas</label>
                <input class="campo__field" type="number" max="2" min="1" placeholder="¿Cuantos?" name="Personas">
            </div>
